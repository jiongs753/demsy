...
$.widget("ech.multiselect", {
	...
	_create: function(){
		...
		var 
			button = (this.button = $('<button type="button"><span class="ui-icon ui-icon-triangle-1-s"></span></button>'))
				.addClass('ui-multiselect ui-widget ui-state-content')
				.addClass( o.classes )
				.attr({ 'title':el.attr('title'), 'aria-haspopup':true, 'tabIndex':el.attr('tabIndex') })
				.insertAfter( el ),
			
			buttonlabel = (this.buttonlabel = $('<div />'))
	...
	refresh: function( init ){
		var el = this.element,
			...
			inputName= el.attr("name") || ('multiselect_'+id);
		...
		this.element.find('option').each(function( i ){
			...
			html.push('<input id="'+inputID+'" name="'+inputName+'" type="'+(o.multiple ? "checkbox" : "radio")+'" value="'+value+'" title="'+title+'"');
			...
			html.push(' /><div>' + title + '</div></label></li>');
		});
