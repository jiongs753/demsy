...
(function($) {
	$.addFlex = function(t, p) {
				...
				if (p.dataType == 'json') {
					$.each(data.rows, function(i, row) {
						...
						function() {
							...
							// If the content has a <BGCOLOR=nnnnnn> option,
							// decode it.
		...
		if (p.usepager) {
			...
			$(g.bDiv).after(g.pDiv);
			var html = ' <div class="pGroup"> <div class="pFirst pButton"><span></span></div><div class="pPrev pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">' + p.pagetext + ' <input type="text" size="4" value="1" /> ' + p.outof
