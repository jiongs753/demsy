/*
 * @(#)Configuration.java 1.00 2007/12/03 Copyright (c) 2007, Stephan Sann
 * 03.12.2007 ssann Vers. 1.0 created
 */

package com.kmetop.demsy.modules.webmail.spi;

import java.util.Properties;

import com.kmetop.demsy.modules.webmail.enums.SmtpHostChoiceEnum;
import com.kmetop.demsy.modules.webmail.util.ClassLoaderUtils;
...
public final class Configuration {
	...
	static {
		...
		try {
			...
			ClassLoader classLoader = ClassLoaderUtils.getCurrentClassLoader(appProps);
		...
		// programVersion = YawebmailVersion.getInstance(appProps
		// .getProperty("program_version"));
		urlCurrentVersion = appProps.getProperty("url_current_version");

		maxLenSubjectOnMailslisting = Integer.parseInt(appProps.getProperty(
				"max_len_subject_on_mailslisting", "50"));
		allMessagesOnOnePage = Boolean.valueOf(
				appProps.getProperty("display_all_messages_on_one_page", "true")).booleanValue();
		amountOfMessagesPerPage = Integer.parseInt(appProps.getProperty(
				"amout_of_messages_per_page", "25"));

		// Set default logon-properties
		portnumberPop3 = Integer.parseInt(logonProps.getProperty("portnumber_pop3", "110"));
		portnumberImap = Integer.parseInt(logonProps.getProperty("portnumber_imap", "143"));
		portnumberPop3s = Integer.parseInt(logonProps.getProperty("portnumber_pop3s", "995"));
		portnumberImaps = Integer.parseInt(logonProps.getProperty("portnumber_imaps", "993"));

		preselectionMailboxHost = logonProps.getProperty("preselection_mailbox_host");
		forcePreselectedMailboxHost = Boolean.valueOf(
				logonProps.getProperty("force_preselected_mailbox_host")).booleanValue();
		preselectionMailboxProtocol = logonProps.getProperty("preselection_mailbox_protocol");
		forcePreselectedMailboxProtocol = Boolean.valueOf(
				logonProps.getProperty("force_preselected_mailbox_protocol")).booleanValue();

		// Set SMTP-properties
		smtpHostChoice = SmtpHostChoiceEnum.byId(smtpProps.getProperty("smtp_host_choice", "free"));
	...
	/**
	 * @param forcedSmtpHostName
	 *            the forcedSmtpHostName to set
	 */
	...
	/**
	 * @param urlCurrentVersion
	 *            the urlCurrentVersion to set
	 */
	...
	/**
	 * @param maxLenSubjectOnMailslisting
	 *            the maxLenSubjectOnMailslisting to set
	 */
	public static void setMaxLenSubjectOnMailslisting(int maxLenSubjectOnMailslisting) {
	...
	/**
	 * @param portnumberImap
	 *            the portnumberImap to set
	 */
	...
	/**
	 * @param portnumberPop3s
	 *            the portnumberPop3s to set
	 */
	...
	/**
	 * @param portnumberImaps
	 *            the portnumberImaps to set
	 */
	...
	/**
	 * @param preselectionMailboxHost
	 *            the preselectionMailboxHost to set
	 */
	...
	/**
	 * @param forcePreselectedMailboxHost
	 *            the forcePreselectedMailboxHost to set
	 */
	public static void setForcePreselectedMailboxHost(boolean forcePreselectedMailboxHost) {
	...
	/**
	 * @param preselectionMailboxProtocol
	 *            the preselectionMailboxProtocol to set
	 */
	public static void setPreselectionMailboxProtocol(String preselectionMailboxProtocol) {
	...
	/**
	 * @param forcePreselectedMailboxProtocol
	 *            the forcePreselectedMailboxProtocol to set
	 */
	public static void setForcePreselectedMailboxProtocol(boolean forcePreselectedMailboxProtocol) {
	...
	/**
	 * @param smtpHostChoice
	 *            the smtpHostChoice to set
	 */
	...
	/**
	 * @param forcedSmtpHostPort
	 *            the forcedSmtpHostPort to set
	 */
	...
	/**
	 * @param amountOfMessagesPerPage
	 *            the amountOfMessagesPerPage to set
	 */
	...
	/**
	 * @param allMessagesOnOnePage
	 *            the allMessagesOnOnePage to set
	 */
