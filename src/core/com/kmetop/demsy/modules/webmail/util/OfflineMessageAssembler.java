/*
 * @(#)OfflineMessageAssembler.java 1.00 2006/05/15 Copyright (c) 2006, Stephan
 * Sann 15.05.2006 ssann Vers. 1.0 created
 */
...
import com.kmetop.demsy.modules.webmail.business.OfflineMimeMessage;
import com.kmetop.demsy.modules.webmail.business.OverviewOfflineMimeMessage;
...
public class OfflineMessageAssembler {
	...
	private static Session SESSION = Session.getInstance(JavamailUtils.getProperties());
	 ...
	 *            soll.
	 */
	public static MimeMessage assembleOverviewOfflineMimeMessage(MimeMessage message) {
		...
		try {
			...
			// Im Fehlerfall geben wir einfach die original Message zurueck. Das
			// ist
	...
	public static MimeMessage assembleOfflineMimeMessage(MimeMessage message) {
		...
		try {
			...
			// Erstmal die uebergebene Message kopieren und Message-Nummer
			// uebernehmen
